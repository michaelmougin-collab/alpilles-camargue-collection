...
export function Services() {
  return (
    <section id="services" className="bg-paper py-[var(--spacing-section)]">
        ...
        <div className="mt-16 grid gap-px overflow-hidden border border-ink/8 bg-ink/8 sm:grid-cols-2 lg:mt-20 lg:grid-cols-3">
          {services.items.map((s, i) => (
            <Reveal key={s.index} delay={(i % 3) * 0.08}>
              <article className="group h-full bg-paper p-9 transition-colors duration-500 hover:bg-ivory lg:p-11">
